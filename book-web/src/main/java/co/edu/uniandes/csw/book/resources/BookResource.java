...
import co.edu.uniandes.csw.book.converters.BookConverter;
...
public class BookResource {
     ...
     *
     * @return Colecci�n de objetos de BookDTO cada uno con sus respectivos
     * Review
     */
    @GET
    ...
    /**
     * Actualiza la informaci�n de una instancia de Book
     *
